...
from egefalos.hippocampus import store_experience, clear as clear_hippo
...
def main():
    ...
    optimizer = torch.optim.AdamW(model2.parameters(), lr=0.001, weight_decay=0.01,
                                   betas=(0.9, 0.999))
    ...
    print(f"  Retention preserved (<5pp): {'YES ✅' if (add_baseline - add_final) < 5.0 else 'NO ❌'}")
