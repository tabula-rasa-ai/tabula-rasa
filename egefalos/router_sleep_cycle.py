...
from egefalos.router_model import RouterModel, RouterConfig, count_router_params, INTENT_NAMES
from egefalos.router_hippocampus import (
...
def consolidate_router_sleep(
    ...
    if exp_ids:
        from egefalos.hippocampus import mark_consolidated
    ...
    # ── Synaptic decay ──────────────────────────────────────────
    try:
        from egefalos.hippocampus import decay_memories
