...
fig.suptitle(
    "Training Stability: EWC Prevents Catastrophic Forgetting",
    fontsize=16,
    fontweight="bold",
    y=1.02,
)
plt.tight_layout()
plt.savefig(
    r"C:\Users\Admin\tabula-rasa\experiments\stability_comparison.png", dpi=200, bbox_inches="tight"
)
...
if three_task and "step4_train_mul" in three_task:
    ...
    ax.set_title(
        "Three-Task Scalability: Immediate Collapse at Task 3", fontsize=14, fontweight="bold"
    )
    ...
    plt.tight_layout()
    plt.savefig(
        r"C:\Users\Admin\tabula-rasa\experiments\three_task_trajectory.png",
        dpi=200,
        bbox_inches="tight",
    )
