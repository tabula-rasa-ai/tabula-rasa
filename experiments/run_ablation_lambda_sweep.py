...
def main():
    ...
    print(f"{'=' * 60}")
    print(
        f"  {'λ':>6} | {'Add Baseline':>13} | {'Add Final':>10} | {'Drop':>7} | {'Sub Final':>10}"
    )
    ...
    for lr_val in LAMBDAS:
        ...
        if combined > best_combined:
            ...
            best_lambda = lr_val
        print(
            f"  {lr_val:>6} | {r['addition_baseline_1d']:>12.1f}% | {r['addition_final_1d']:>9.1f}% | {drop_str:>7} | {r['subtraction_final_1d']:>9.1f}%"
        )
