...
plt.tight_layout()
plt.savefig(
    r"C:\Users\Admin\tabula-rasa\experiments\stability_comparison.png", dpi=150, bbox_inches="tight"
)
print("SAVED: experiments\\stability_comparison.png")
print()
print("=== KEY NUMBERS ===")
print(
    f"Without EWC: Addition {noewc_add[0]:.0f}% -> {min(noewc_add):.0f}% (crash) -> {noewc_add[-1]:.0f}% (end)"
)
